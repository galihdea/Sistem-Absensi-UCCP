<!--footer section start-->
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>SAUCCP</h1></span> 
				...
				<!--/down-->
					<div class="down">	
						...
						<a href="admin_dashboard.php"><span class=" name-caret"><?php echo $nama;?></span></a>
						 <p><?php echo $_SESSION['jenis_user'];?></p>
						<ul>
                    ...
                    <div class="menu">
						<ul id="menu" >
							...
							<li><a href="menu_kelolaadmin.php"><i class="fa fa-table"></i> <span>Kelola Admin</span></a></li> <?php }?>
