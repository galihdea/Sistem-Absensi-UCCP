				...
				<tbody> 
					<?php
						...
						<td align="center" class="isitabel" style="max-width: 10px; padding: 5px 5px 5px 15px !important; border-bottom-width: 2px !important;">';
							...
							echo '<a '.$tanya.' class="btn blue four mini-btn bgyellow" href="functions/reset_password_admin.php?id_user='.$id_user.'" data-toggle="tooltip" data-placement="bottom" title="Reset Password"><i class="fa fa-key"></i></a>';
