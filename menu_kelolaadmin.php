				...
				<tbody> 
					<?php
						...
						<td align="center" class="isitabel" style="max-width: 10px; padding: 5px 5px 5px 15px !important; border-bottom-width: 2px !important;">';
							...
							echo '<a '.$tanya.' class="btn blue four mini-btn bgyellow" href="functions/reset_password_admin.php?id_user='.$id_user.'" data-toggle="tooltip" data-placement="bottom" title="Reset Password"><i class="fa fa-eye"></i></a>';
							...
							//alert hapus
							$t2 = "' menghapus username `".$user['username']."`?'";
							$tanya2 = 'onclick="return konfirmasi('.$t2.')"';
							echo '<a '.$tanya2.' class="btn blue four mini-btn bgred" href="functions/hapus_admin.php?id_admin='.$id_luar.'" data-toggle="tooltip" data-placement="bottom" title="Hapus"><i class="fa fa-trash-o"></i></a>
						</td>  
					</tr>';
