			...
			<table id="example" class="table table-striped table-bordered" style="width:100%; font-size: 15px;">
				<thead> 
					<tr> 
						...
						<th class="header">Keterangan (Tanggal)</th>
		      ...
		      <div class="modal-content">
		        ...
		        <form method="POST" action="" class="form-horizontal">
					<div class="form-group" style="margin-top: 15px;margin-left: 15px;margin-right: 15px;margin-bottom: 15px">
						...
						<a href="https://www.google.com/maps/search/?api=1&query='.$latlon.'" target="_blank"><label  style="cursor: pointer;" for="focusedinput" class="col-sm-10 control-label ratakiri" style="cursor: pointer;">Lihat di Google Maps</label></a>
					</div>
					<!-- Modal footer -->
