		...
		<!-- header-starts -->
							...
							<!--//outer-wp-->
								...
								<!--custom-widgets-->
									 ...
									 <!--footer section start-->
										<footer>
										   <p>© 2016 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a></p>
										</footer>
									<!--footer section end-->
								</div>
									 <!--footer section start-->
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="karyawan.php"> <span id="logo"> <h1>Augment</h1></span> 
