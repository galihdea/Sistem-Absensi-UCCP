				      ...
				      <div class="modal-content">
				        ...
				        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" class="form-horizontal">
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label ratakiri">Dari</label>
								<div class="col-sm-10">
									<input name="tanggal1" type="date" class="form-control1" id="focusedinput" placeholder="tanggal">
								</div>
								<label for="focusedinput" class="col-sm-2 control-label ratakiri">Sampai</label>
								<div class="col-sm-10">
									<input name="tanggal2" type="date" class="form-control1" id="focusedinput" placeholder="tanggal">
								</div>
								<label for="focusedinput" class="col-sm-2 control-label ratakiri">Jumlah Hari</label>
								<div class="col-sm-10">
									<input name="hari" type="number" class="form-control1" id="focusedinput" placeholder="jumlah hari (hari kerja)" required>
								</div>
							</div>
							<!-- Modal footer -->
